...
class User
{
  ...
  public function info(){
    print_r("名前:".$this->name.PHP_EOL);
    print_r("年齢:".$this->age.PHP_EOL);
    print_r("性別:".$this->gender.PHP_EOL);
  }
}
...
class Man
{
  ...
  public function introduce(){
      ...
      print_r("はいさいまいど〜,".$this->name."です!!!".PHP_EOL);
    }
  }
}
...
class Zoo
{
  ...
  public function __construct($zoo_name,$zoo_fee) {
    $this->name =$zoo_name;
    $this->fee =$zoo_fee;
  }
  public function info_entry_fee($human){
    ...
    if($human->age >=0 && $human->age <=5){
      print_r($human->name."さんの入場料金は".$this->fee["infant"]."円です。".PHP_EOL);
    }elseif($human->age >=6 && $human->age <=12){
      print_r($human->name."さんの入場料金は".$this->fee["children"]."円です。".PHP_EOL);
    }elseif($human->age >=13 && $human->age <=64){
      print_r($human->name."さんの入場料金は".$this->fee["adult"]."円です。".PHP_EOL);
    }elseif($human->age >=65 && $human->age <=120){
      print_r($human->name."さんの入場料金は".$this->fee["senior"]."円です。".PHP_EOL);
    }
  } 
}
